    ...
    >
      ...
      <DialogPrimitive.Close 
        className={cn(
          ...
          "text-[#213555] opacity-70 transition-all",
          "hover:opacity-100 hover:bg-[#F5EFE7]",
          "focus:outline-none focus:ring-2 focus:ring-[#213555] focus:ring-offset-2",
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      ...
      "mt-4 pt-4 border-t border-[#D8C4B6]",
      className
    )}
    {...props}
  />
